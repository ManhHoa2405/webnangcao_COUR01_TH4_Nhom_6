...
<body>
    <header class="header">
        ...
        <div class="logo-shop">
            <a href="{{ url('/') }}">
                <img src="{{ asset('images/logo.png') }}" alt="Hiang Food Logo" title="Trở về trang chủ">
            </a>
        </div>
        <!-- Actions -->
        <div class="header-actions">
            ...
            <a class="header-action" href="{{ route('products.index') }}" title="Quản lý sản phẩm">
            ...
            <a href="{{ url('/admin/profit') }}" class="header-action">
    ...
    <div class="admin-content">
        <h1>Quản lý hiệu quả – Phục vụ tận tâm.</h1>
    </div>

    <div class="img-admin">
        <img src="{{ asset('images/admin-image.avif') }}" alt="admin-image" title="Hình ảnh quản trị">
    </div>
